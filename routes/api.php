...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/activity-logs', [ActivityLogController::class, 'index']); // Revisar path si es 'Controllers'
    ...
    Route::middleware(['can:is-admin'])->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('punto-gobs/{puntoGob}/institutions', [PuntoGOBInstitutionController::class, 'index']);
        Route::post('punto-gobs/{puntoGob}/institutions/attach', [PuntoGOBInstitutionController::class, 'attach']);
        Route::delete('punto-gobs/{puntoGob}/institutions/{institution}/detach', [PuntoGOBInstitutionController::class, 'detach']);
    });
});